...
void etcdv3::AsyncWatchAction::waitForResponse(watcher_callback callback, void* ptr)
//void etcdv3::AsyncWatchAction::waitForResponse(std::function<void(etcd::Response)> callback,void* ptr)
{
	void* got_tag;
	bool ok = false;
