...
class Request : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:etcdserverpb.Request) */ {
 ...
 private:
  ...
  inline void set_has_prevvalue();
  inline void clear_has_prevvalue();
  inline void set_has_previndex();
  inline void clear_has_previndex();
  inline void set_has_prevexist();
  inline void clear_has_prevexist();
  inline void set_has_expiration();
  inline void clear_has_expiration();
  inline void set_has_wait();
  inline void clear_has_wait();
  inline void set_has_since();
  inline void clear_has_since();
  ...
  friend void  protobuf_AddDesc_etcdserver_2eproto();
  friend void protobuf_AssignDesc_etcdserver_2eproto();
  friend void protobuf_ShutdownFile_etcdserver_2eproto();
